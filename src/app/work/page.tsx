...
function resolveLocale(field: LocaleString, locale: "es" | "en" = "es"): string {
  if (!field) return "";
...
export default function WorkPage() {
  ...
  const [isMobile, setIsMobile]   = useState(true); // mobile-first: true until JS confirms desktop
        ...
        >
          {projects.map((p, idx) => (
            ...
            >
              <div className="work-card-media" style={{
                ...
                aspectRatio: isMobile ? "4 / 4.7" : (aspectRatio[p.sizeWork ?? "wide"] ?? "16 / 11"),
              }}>
                {p.coverImage?.asset ? (
                  <Image
              ...
              <p style={{
                ...
                {resolveLocale(p.description, locale)}
              </p>
            </Link>
          ))}
          ...
          <div data-reveal style={{ display: "flex", flexDirection: "column" }}>
            <div className="work-card-media" style={{
              ...
              aspectRatio: isMobile ? "4 / 4.7" : "4 / 5", display: "grid", placeItems: "center",
            }}>
